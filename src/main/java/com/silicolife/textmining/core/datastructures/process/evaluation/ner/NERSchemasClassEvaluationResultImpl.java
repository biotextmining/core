...
public class NERSchemasClassEvaluationResultImpl extends EvaluationImpl implements INERSchemaEvaluationResult{

	private NERSchemasEvaluationResultsImpl results;
	
	public NERSchemasClassEvaluationResultImpl(NERSchemasEvaluationResultsImpl results) {
