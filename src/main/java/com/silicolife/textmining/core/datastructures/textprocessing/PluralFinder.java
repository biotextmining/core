...
public class PluralFinder {
   ...
   private static final PluralFinder _INSTANCE = new PluralFinder();

   public static final PluralFinder getInstance() {
       return _INSTANCE;
   }
   ...
   protected PluralFinder( PluralFinder original ) {
   ...
   @Override
   public PluralFinder clone() {
       return new PluralFinder(this);
   }
...
//	   System.out.println(PluralFinder.getInstance().pluralize("rule"));
//   }
