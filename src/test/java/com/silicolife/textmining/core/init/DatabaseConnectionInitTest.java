...
//	@Test
	public void testDatabaseconnection() throws InvalidDatabaseAccess
	{
		...
		assertTrue(checkConnection(dabaseAcess));
	}
	 ...
	 * @throws SQLException 
	 */
	private IDatabase factoryDatabase(String host,String port,String schema,String username,String password) throws InvalidDatabaseAccess
	{
